...
// LoadFromJSONBruteForce walks JSON and picks every value that can be parsed as CIDR.
func LoadFromJSONBruteForce(u string, tr *CIDRIndex, name string) error {
	return loadFromJSON(
		u,
...
func LoadFromTextGroupIPs(u string, tr *CIDRIndex, name string) error {
	var ips []string
...
func LoadFromTextGroupCIDRs(u string, tr *CIDRIndex, name string) error {
	var cidrs []string
